                                    ...
                                    <form action="web_script.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="username">Video Category</label>
                                        ...
                                        <div class="container">
                                            <div class="text-center">
                                                <div class="form-group">
                                                    <button type="submit" name="add_video" class="btn btn-primary btn-lg">Add </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <img src="uploads/Videos/<?php echo $data['image']; ?>" style="height: 60px;width:60px;">
                                                    </td>
                                                    <td><video width="200px" height="200px" controls>
                                                          <source src="uploads/Videos/<?php echo $data['video']; ?>" type="video/mp4">
                                                      </video>
                                                  </td>
                                                    <td>
                                                        <div class="justify-content-between">
                                                            <a href="remove.php?video=<?php echo $w1; ?>" style="height: 30px;width:40px;"><i class="fas fa-trash btn btn-outline-danger" class=""></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>

                                    ...
                                    <form action="web_script.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="heading" name='heading' class="form-control" maxlength="100" required>
                                        ...
                                        <div class="container">
                                            <div class="text-center">
                                                <div class="form-group">
                                                    <button type="submit" name="add_blog" class="btn btn-primary btn-lg">Add </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><img src="Uploads/Blog Images/<?php echo $data['image']; ?>" style="height: 60px;width:60px;">
                                                    </td>
                                                    <td>
                                                        <div class="justify-content-between">
                                                            <a href="edit_blog.php?blog=<?php echo $w1; ?>" style="height: 30px;width:40px;"><i class="fas fa-edit btn btn-outline-primary" class=""></i></a>
                                                            <a href="remove.php?blog=<?php echo $w1; ?>" style="height: 30px;width:40px;"><i class="fas fa-trash btn btn-outline-danger" class=""></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>

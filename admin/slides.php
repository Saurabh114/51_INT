...
<head>
    ...
    <title>Admin Panel | Add Slides </title>
    <!-- General CSS Files -->
                                    ...
                                    <form action="web_script.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" row="3" name="description" id="description" maxlength="60" class="form-control" required>
                                        ...
                                        <div class="container">
                                            <div class="text-center">
                                                <div class="form-group">
                                                    <button type="submit" name="add_slide" class="btn btn-primary btn-lg">Add </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr class="text-center">
                                                    <td><?php echo $i++; ?></td>
                                                    <td><img src="uploads/Slide Images/<?php echo $data['image']; ?>" style="height: 60px;width:60px;"></td>
                                                    <td><?php echo $data['heading']; ?></td>
                                                    <td><?php echo $data['description']; ?></td>
                                                    <td>
                                                        <div class="justify-content-between">
                                                            <a href="edit_slides.php?slide=<?php echo $w1; ?>" style="height: 30px;width:40px;"><i class="fas fa-edit btn btn-outline-primary" class=""></i></a>
                                                            <a href="remove.php?slide=<?php echo $w1; ?>" style="height: 30px;width:40px;"><i class="fas fa-trash btn btn-outline-danger" class=""></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
